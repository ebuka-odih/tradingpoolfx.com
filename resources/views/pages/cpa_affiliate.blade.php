...
@section('content')
    ...
    <style>
        ...
        .footer_banner_bottom_fixed .banner_bottom{display:none !important;}
    </style>
    <div class="cpa_affilicated_programs">
            ...
            <div class="inner">
                ...
                <div class="pages_text_and_image_row text_and_image_position_right">
                    <div class="text_and_image_inner">
                        ...
                        <div class="img_box" style="background-image:url('../../assets/home/cpa_img1.1.jpg'); background-position:center top; background-repeat:no-repeat; background-size:cover;">
                            <img src="../../assets/home/cpa_img1.1.jpg" alt="" />
                            <span>
                  EARN UP TO<br /><strong>$800 cpa</strong>
        ...
        <div class="cpa_affilicated_programs_text">
            <div class="inner">
                <div class="text_left left">
                    <img src="../../assets/home/cpa_img_8.png" alt="">
                </div>
                <div class="text_right right">
                    <h3>Transparent. Profitable. Robust.</h3>
                    <p>Access our suite of highly effective<br/>
                        marketing tools through CellXpert for<br/>
                        more conversions and <br/>increased profits.
                    </p>
                    <a href="register" class="red_arrow_button">BECOME A CPA AFFILIATE</a>
                </div>
                <div class="clear"></div>
        ...
        <div class="accounts_proecn_step_wrapper">
            <div class="inner">
                <div class="pages_text_and_image_row text_and_image_position_left">
                    <div class="text_and_image_inner">
                        ...
                        <div class="img_box" style="background-image:url('../../assets/home/cpa_img5.jpg'); background-position:center top; background-repeat:no-repeat; background-size:cover;">
                            ...
                            <span>
                  <strong>300+ ASSETS</strong><br />TO TRADE
                ...
                <div class="accounts_proecn_step_content">
                    <h2 class="page_title_center"><strong>IT’S EASY TO START</strong> EARNING USING AN AUTOMATED TRADING SYSTEM </h2>
                    <ul>
                        <li>
                            <div class="text_box">
                                <div class="text_box_inner">
                                    <h3>Sign up<span>1</span></h3>
                                    <p>Become a CPA partner and get FREE access to the CellXpert affiliate tracking platform.</p>
                                    <BR/>
                                    <a href="register" class="red_button">SIGN UP NOW</a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="text_box blue_text_box">
                                <div class="text_box_inner">
                                    <h3>Refer<span>2</span></h3>
                                    <p>Refer clients using our suite of professionally designed landing pages and banners!</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="text_box">
                                <div class="text_box_inner">
                                    <h3>Earn<span>3</span></h3>
                                    <p>Earn up to $800 per referred account PLUS attractive monthly bonuses.</p>
                                </div>
                            </div>
                        </li>
                    </ul>
